...
// SliverAppBarWidget(expandedHeight: kPS400px, centerTitle:true, dataFuture:_movieData.getMovieDetails(widget.movieID!), builder: (context,snapShot){
...
//           final movieData = snapShot.data;
          ...
          //         ),
          //        ///ProductionCompanies
          //        FutureBuilder<List<ProductionCompaniesVO>?>(future: _movieData.getCompanyList(widget.movieID!),builder: (context,snapShot){
          //          if(snapShot.connectionState == ConnectionState.waiting){
          //            return const Center(child: CircularProgressIndicator(color: Colors.red,),);
          //          }else if(snapShot.hasError){
          //            return const Center(child: Text("errorTitle"),);
